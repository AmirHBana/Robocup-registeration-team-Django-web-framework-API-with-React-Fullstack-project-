...
AUTHENTICATION_BACKENDS = (
    'userauths.authentication.PhoneOrEmailBackend',
...
SIMPLE_JWT= {
    ...
    'USER_AUTHENTICATION_CLASSES': ('rest_framework_simplejwt.tokens.AccessToken',),
...
JAZZMIN_SETTINGS = {
    ...
    "site_brand": "AmirHBana",
    "copyright": "All Right Reserved www.github.com/AmirHBana 2024",
    'show_sidebar': True,
    "welcome_sign": "Welcome to the Ecommerce Store Admin, Login now",

    # Customize the admin panel and copy the code and put in JAZZMIN_UI_TWEAKS
