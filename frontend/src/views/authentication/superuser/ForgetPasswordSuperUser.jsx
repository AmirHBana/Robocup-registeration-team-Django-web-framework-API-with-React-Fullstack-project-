...
import {forgetpasswordsuperuser} from "../../../utils/auth.js";
...
function ForgetPasswordSuperUser() {
    ...
    const handleSubmit = async (e) => {
        ...
        const { error } = await forgetpasswordsuperuser(national_code, username, email, password2, password3);
                    ...
                    <div className="signin">
                        <div className="content">
                            ...
                            <form className="form" onSubmit={handleSubmit}>
                                ...
                                <div className="links"><Link to={"/admin-register/"}>ثبت نام</Link> <Link
                                    to={"/admin-login/"}>ورود</Link></div>
...
export default ForgetPasswordSuperUser